...
var require_warning = __commonJS({
  "node_modules/warning/warning.js"(exports, module) {
    ...
    if (__DEV__) {
      ...
      warning7 = function(condition, format, args) {
        var len = arguments.length;
...
var Button = React15.forwardRef((_ref, ref) => {
  let {
    as: asProp,
    disabled
  } = _ref, props = _objectWithoutPropertiesLoose3(_ref, _excluded);
  const [buttonProps, {
    tagName: Component2
...
var Anchor = React16.forwardRef((_ref, ref) => {
  let {
    onKeyDown
  } = _ref, props = _objectWithoutPropertiesLoose4(_ref, _excluded2);
...
function usePopper(referenceElement, popperElement, _ref = {}) {
  ...
  } = _ref, config = _objectWithoutPropertiesLoose5(_ref, _excluded3);
...
function DropdownMenu(_ref) {
  let {
    children
  } = _ref, options = _objectWithoutPropertiesLoose6(_ref, _excluded4);
...
var DropdownItem = React41.forwardRef((_ref, ref) => {
  ...
  } = _ref, props = _objectWithoutPropertiesLoose7(_ref, _excluded5);
...
var NavItem = React70.forwardRef((_ref, ref) => {
  let {
    ...
    active,
    eventKey
  } = _ref, options = _objectWithoutPropertiesLoose8(_ref, _excluded6);
...
var Nav = React71.forwardRef((_ref, ref) => {
  let {
    ...
    role,
    onKeyDown
  } = _ref, props = _objectWithoutPropertiesLoose9(_ref, _excluded7);
  const forceUpdate = useForceUpdate();
...
var Modal = (0, import_react63.forwardRef)((_ref, ref) => {
  let {
    ...
    onEntering,
    onEntered
  } = _ref, rest = _objectWithoutPropertiesLoose10(_ref, _excluded8);
...
var Offcanvas = React88.forwardRef(({
  ...
  return (0, import_jsx_runtime86.jsxs)(import_jsx_runtime85.Fragment, {
    children: [!showOffcanvas && renderDialog({}), (0, import_jsx_runtime84.jsx)(ModalContext_default.Provider, {
      value: modalContext,
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react76.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime96.jsxs)(import_jsx_runtime95.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react78.cloneElement)(children, triggerProps), (0, import_jsx_runtime94.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
function useTabPanel(_ref) {
  let {
    ...
    onExiting,
    onExited
  } = _ref, props = _objectWithoutPropertiesLoose11(_ref, _excluded9);
