...
(function (global, factory) {
	...
	var Nzh = function(lang){
		this.lang = lang;
		this.encode = function(){return src.CL.apply(lang,arguments)};
		this.decode = function(){return src.unCL.apply(lang,arguments)};
		this.toMoney = function(){return src.toMoney.apply(lang,arguments)};
	};
	Nzh.langs = langs;
	Nzh.cn = autoGet(langs.s,langs.b);
	Nzh.hk = autoGet(langs.hk_s,langs.hk_b);
	var nzh = Nzh;
